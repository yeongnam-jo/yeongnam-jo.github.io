...
![image-20200506135534537](C:\Users\HP\AppData\Roaming\Typora\typora-user-images\image-20200506135534537.png)
...
![image-20200506135502420](C:\Users\HP\AppData\Roaming\Typora\typora-user-images\image-20200506135502420.png)
...
- SELECT ENAME,SAL,SAL*100, SAL||'00',to_char(SAL)||'00' FROM EMP;
  - ORACLE DBMS는 문자를 '' 으로 둘러싼다.
  - || 문자열 합성 연산자
  - ★to_char() 숫자 타입을 문자타입으로 변환하는 함수
  - SAL||'00' => 문자(왼쪽 정렬)
  - SAL * 100 => 숫자(오른쪽 정렬)
...
- FUNCTION [역할] : 입력값(Input Data)을 기반으로 특정 연산을 수행하여 결과값(Output Data) 값을 리턴(Return)하는 단위 기능 모듈(Module) 
  ...
  ![image-20200506170819202](C:\Users\HP\AppData\Roaming\Typora\typora-user-images\image-20200506170819202.png)
