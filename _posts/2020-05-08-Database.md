...
2. 다음의 날짜 포맷을 조사하여 암기 후 설명하십시오.
   ...
   - 공백
     ...
     - FM: ?????????????? => REMOVE PADDED BALNCK
     - 아하. SELECT 123456, TO_CHAR(123456,'999999'), LENGTH(TO_CHAR(123456,'999999')), LENGTH(TO_CHAR(123456,'fm999999'))  FROM  DUAL; 
